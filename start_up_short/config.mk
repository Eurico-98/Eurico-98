...
GMTSARHOME	= /home/$USER/software/gmtsar
ORBITS_DIR	= /usr/local/orbits
TIFF_INC	= /usr/local/include
TIFF_LIB	= /usr/local/lib
LALIBS		= -llapack -lblas
prefix          = /home/$USER/software/gmtsar
exec_prefix     = ${prefix}
bindir		= $(DESTDIR)${exec_prefix}/bin
sharedir	= $(DESTDIR)/home/$USER/software/gmtsar/share/gmtsar
...
#-------------------------------------------------------------------------------
GMTSAR		= -L/home/$USER/software/gmtsar/gmtsar -lgmtsar
#
#-------------------------------------------------------------------------------
...
LDFLAGS		=  -m64 -s -Wl,-rpath,/usr/lib/x86_64-linux-gnu
#
#-------------------------------------------------------------------------------
